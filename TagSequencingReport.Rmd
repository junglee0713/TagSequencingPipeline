...
# Define file paths
base_dir <- "/media/8TB_PLAYGROUND/tanesc/friedman/qiime1"
#base_dir <- "/home/tanesc"

work_dir <- file.path(base_dir, "SparseFur")
mapping_file_fp <- file.path(work_dir, "friedman_qiime_mapping_keepers.tsv")
otu_table_fp <- file.path(work_dir, "otu", "classic_otu_table.txt")
