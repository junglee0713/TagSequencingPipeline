...
SampleIDorig_present_in_s_toPlot <- s_toPlot$SampleIDorig[s_toPlot$Keep]

dist_in <- read_qiime_distmat(dist_fp)
SampleIDorig_present_in_dist_in <- attributes(dist_in)$Labels

dist_in <- dist_subset(dist_in, intersect(SampleIDorig_present_in_dist_in, SampleIDorig_present_in_s_toPlot))
